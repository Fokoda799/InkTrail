...
export const NotificationsMenu: React.FC<NotificationsMenuProps> = ({
  ...
  return (
    <>
      {isNotificationsOpen && (
        <AnimatePresence>
            <div className="fixed h-screen inset-0 bg-black bg-opacity-50 sm:hidden z-40" onClick={() => setIsNotificationsOpen(false)}></div>
            <motion.div
              ...
              className="absolute right-0 top-12 mt-2 w-96 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 overflow-hidden"
            >
              {/* Header */}
